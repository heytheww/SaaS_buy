...
CREATE TABLE user(
    ...
    role TINYINT NOT NULL COMMENT '角色：0管理员 1普通用户',
...
CREATE TABLE buy_order(
    ...
    status TINYINT UNSIGNED NOT NULL COMMENT '订单状态：1待支付 2已支付 3取消',
...
VALUES(1,2,3,"10001223324aashhhrf00001",1,"张三","13244554455","广东省深圳市宝安区123号",
"",UTC_DATE(),UTC_DATE())
